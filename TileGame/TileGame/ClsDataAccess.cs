...
namespace TileGame
{
    class ClsDataAccess
    {
        ...
        public static DataSet selectCharacter()
        {
            List<MySqlParameter> ParamList = new List<MySqlParameter>();
            var paramCharacterName = new MySqlParameter("@CharacterName", MySqlDbType.VarChar, 32);
            var paramUserName = new MySqlParameter("@UserName", MySqlDbType.VarChar, 32);
        ...
        public static DataSet characterReturnToMap(string pDirection, string pMap)
        {
            List<MySqlParameter> ParamList = new List<MySqlParameter>();
            var paramCharacter = new MySqlParameter("@Character", MySqlDbType.VarChar, 32);
            var paramMap = new MySqlParameter("@Map", MySqlDbType.VarChar, 16);
        ...
        public static DataSet getCharacterSkills(string pCharacter)
        {
            List<MySqlParameter> ParamList = new List<MySqlParameter>();
            var paramCharacter = new MySqlParameter("@Character", MySqlDbType.VarChar, 32);
            paramCharacter.Value = pCharacter;
            ParamList.Add(paramCharacter);
            try
            {
                var aDataSet = MySqlHelper.ExecuteDataset(mySqlConnection, "CALL getCharacterSkills(@Character)", ParamList.ToArray());
                return aDataSet;
            }
            catch (ArgumentException)
            {
        ...
        public static DataSet getUserDetails()
        {
            ...
            try
            {
                var aDataSet = MySqlHelper.ExecuteDataset(mySqlConnection, "CALL getUserDetails(@Username)", ParamList.ToArray());
                return aDataSet;
            }
            catch (ArgumentException)
            {
        ...
        public static DataSet getAllCharactersInMap()
        {
            List<MySqlParameter> ParamList = new List<MySqlParameter>();
            var paramMap = new MySqlParameter("@Map", MySqlDbType.VarChar, 16);
            paramMap.Value = MapName;
            ...
            try
            {
                var aDataSet = MySqlHelper.ExecuteDataset(mySqlConnection, "CALL getAllCharactersInMap(@Map)", ParamList.ToArray());
                return aDataSet;
            }
            catch (ArgumentException)
            {
        ...
        public static DataSet getAllItemsInMap()
        {
            List<MySqlParameter> ParamList = new List<MySqlParameter>();
            var paramMap = new MySqlParameter("@Map", MySqlDbType.VarChar, 16);
            paramMap.Value = MapName;
            ...
            try
            {
                var aDataSet = MySqlHelper.ExecuteDataset(mySqlConnection, "CALL getAllItemsInMap(@Map)", ParamList.ToArray());
                return aDataSet;
            }
            catch (ArgumentException)
            {
        ...
        public static DataSet getCharacterMessages()
        {
            try
            {
                var aDataSet = MySqlHelper.ExecuteDataset(mySqlConnection, "Call getChatMessages()");
                return aDataSet;
            }
